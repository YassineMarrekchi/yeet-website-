...
if (mysqli_num_rows($result) > 0) {
  ...
  // Display the user information in the HTML page
...
?>
<button type="button" class="btn btn-success btn-lg btn-block"><i class="fa-solid fa-cart-shopping"> User Cart</i></button>
