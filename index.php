...
<body>
  ...
  <img src="https://i.ibb.co/fC0ZqL3/bg2.png" height="950px" style="padding-bottom: 75px; width:100%">
  <div class="row" style=" margin: auto; width: 50%; border: 3px solid; border-radius: 25% 10%; padding: 10px;">
    ...
    padding: 10px;">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">૮(˶˃ᆺ˂˶)</h5>
          <p class="card-text">YEET enables the mainstream to buy and sell gaming digital goods and assets including Accessories, games, and more. YEET is trusted and built upon a proven architecture that has delivered security and scalability for millions of digital goods and asset transactions.</p>
          <a href="#" class="btn btn-outline-danger">KEEP EXPLORING US</a>
        </div>
      </div>
    </div>
  </div>
