          ...
          ?>
              <div class="col-md-3  mt-2">
                    <div class="card" style="width: 18rem;">
                      <img class="card-img-top" src="<?php echo $row["Game_img"];?>" alt="Card image cap">
                      <div class="card-body">
                        <h5 class="card-title"><?php echo $row["Game_name"]?></h5>
                        <p class="card-text"><?php echo $row["Game_price"]?></p>
                        <button type="button" name="buttondetails" class="btn btn-outline-dark" id="<?php echo $row["Game_ID"];?>" onclick="location.href='gamedetails.php?id=<?php echo $row["Game_ID"];?>'" >product details</button>
                      </div>
                    </div>
              </div>
