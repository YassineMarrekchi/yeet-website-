...
<body>
  ...
  padding: 10px;
    ...
    <?php 
            ...
            $query = "SELECT * FROM games WHERE Game_ID = " . $_GET['id'];
      ...
      <div class="center">
      <img src="<?php echo $row["Game_img"];?>" class="img-thumbnail" alt="..." height="300px" width="400px"   style="margin-bottom: 10px padding-bottom: 10px;">
      </div> 
      </div> 
      <div class="block">
      <div class="card text-white bg-dark mb-3" style="max-width: 100%; font-family: cursive; font-size: 1.875em"><?php echo $row["Game_name"]?> </div> 
      </div>
